...
rehydrates the decisions and the scan prices, then hands both to the
existing, tested execute_signals(), which brings along the
...
def execute_premarket_decisions(
    ...
    report = execute_signals(
        decisions,
        submit=submit,
        reference_prices=_reference_prices(),
